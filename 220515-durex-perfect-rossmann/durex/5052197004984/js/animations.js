...
const revealDurex = document.getElementsByClassName("es-kv__img-durex");
for (let esElement = 0; esElement < revealDurex.length; esElement++) {
  new ScrollMagic.Scene({
    triggerElement: revealDurex[esElement],
    offset: 50,
    triggerHook: 0.9,
    reverse: false
  })
    .setClassToggle(revealDurex[esElement], "visible")
    .addTo(controller);
}
